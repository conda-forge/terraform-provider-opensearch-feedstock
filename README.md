About terraform-provider-opensearch-feedstock
=============================================
...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/terraform-provider-opensearch-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/terraform-provider-opensearch-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add terraform-provider-opensearch
# for installing globally
pixi global install terraform-provider-opensearch
```
...
It is possible to list all of the versions of `terraform-provider-opensearch` available on your platform:
...
```
pixi search terraform-provider-opensearch --channel conda-forge
```
